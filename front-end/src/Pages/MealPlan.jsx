...
const MealPlanGenerator = ({ loggedInUser }) => {
    // Support both state and localStorage (e.g. on page refresh)
    let user = loggedInUser;
    if (!user) {
        try {
            const stored = JSON.parse(localStorage.getItem('user') || 'null');
            user = stored?._id || stored?.userId || stored;
        } catch {}
    }
        ...
        <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="mt-2 text-lg text-gray-600">Get a personalized nutrition and activity plan designed to support your treatment and long term health</p>
                </div>
