...
/**
 * Staff/Admin entry portal at /staff.
 * Doctor and Hospital login - no patient options.
 */
export default function StaffPortal() {
  const roles = [
    {
      title: "Clinical Staff",
      subtitle: "Create consultation recommendations and monitor assigned patients",
      cta: "Doctor Login",
      href: "/doctor/login",
      icon: (
    ...
    },
    {
      ...
      subtitle: "Institution-level monitoring, alerts, reports, and staff management",
